...
function prasoon_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'prasoon' ),
	) );
...
function prasoon_widgets_init() {
  ...
  register_sidebar( array(
		'name'          => esc_html__( 'Wines Template.', 'prasoon' ),
		'id'            => 'business-sidebar',
		'description'   => '',
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Alex Widget Template.', 'prasoon' ),
		'id'            => 'custom-sidebar',
		'description'   => '',
		'before_widget' => '',
		'after_widget'  => '',
 ...
 */
if ( ! function_exists( 'prasoon_dynaminc_css' ) ) :
 function prasoon_dynaminc_css() {
   require(get_template_directory().'/layouts/dynamic.css.php');
   exit;
}
endif;
add_action('wp_ajax_dynamic_css', 'prasoon_dynaminc_css');
add_action('wp_ajax_nopriv_dynamic_css', 'prasoon_dynaminc_css');
 

if ( ! function_exists( 'prasoon_scripts' ) ) :
function prasoon_scripts() {
	wp_enqueue_style( 'style', get_stylesheet_uri() );
	wp_enqueue_style( 'AS-Styles', get_template_directory_uri() . '/layouts/asstyle.css', array(), null );
	...
	wp_enqueue_script( 'modernizr', 'https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.6.2/modernizr.js', array(), '2.6.2', true );	
	...
	wp_enqueue_script( 'jquery-3-2-3-js', get_template_directory_uri() . '/js/jquery-3.2.1.js', array('jquery'), '', true );
...
//Filter the word category
add_filter( 'get_the_archive_title', function ($title) {

    if ( is_category() ) {

            $title = single_cat_title( 'Sweetness: ', false );
...
function wpb_sender_email( $original_email_address ) {
    return 'hv@herreravineyards.com';
}
 
// Function to change sender name
function wpb_sender_name( $original_email_from ) {
    return 'Herrera Vineyards';
}
