	   ...
	   <div class="section-inner wow fadeInUp">
            <div class="container">
                <div class="about-section">
                    <div class="row">
                        <div class="title wow fadeInUp" data-wow-duration=".5s" data-wow-delay="0s">
                            <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="content">
                            <div class="col-md-5 col-sm-12 col-xs-12 wow slideInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12 wow slideInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                <?php
                                    if(!empty($image)):
