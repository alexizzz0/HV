...
function prasoon_customize_register( $wp_customize ) {
    ...
    $wp_customize->selective_refresh->add_partial( 'home_heading_text', array(
        ...
        'settings'            => 'home_heading_text',     
        'render_callback'     => 'home_heading_text_render_callback',
    ...
    $wp_customize->selective_refresh->add_partial( 'home_subheading_text', array(
        ...
        'settings'            => 'home_subheading_text',     
        'render_callback'     => 'home_subheading_text_render_callback',
        'fallback_refresh'    => false, 
    ));
...
* @return mixed
*/
if ( ! function_exists( 'home_heading_text_render_callback' ) ) :
function home_heading_text_render_callback() {
...
* @return mixed
*/
if ( ! function_exists( 'home_subheading_text_render_callback' ) ) :
function home_subheading_text_render_callback() {
...
* @return mixed
*/
if ( ! function_exists( 'home_button_text_render_callback' ) ) :
function home_button_text_render_callback() {
