...
?>
	...
	<style>
		.ASSlides {display:none;}
	</style>
	<body <?php body_class(); ?>>
		<?php
    	if("yes" === get_theme_mod( 'preloader_display' )){
      		?>
			<!-- Begin Preloader -->
									...
									<div class="col-md-1 col-sm-1">
										<div class="navbar-header">
											<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
        		          						<span class="sr-only"><?php esc_html_e( 'Toggle navigation', 'prasoon' ); ?></span>
			...
			<section id="home">
				<?php 
		      		if("slider" != get_theme_mod( 'slide_option1_radio' )){
		        		/* check for parallax */
		        		if("yes" === get_theme_mod( 'home_parallax','yes' )){
						/* show parallax */
				?>
					...
					<div class="cover-home-overlay"></div>
						...
						<div class="cover-home" style="background:url('<?php echo esc_url(get_theme_mod( 'theme_home_bg' )); ?>') no-repeat;">
			        		...
			        		?>
								<div class="promo-section wow fadeInUp" data-wow-duration="2s" data-wow-delay="1s">
									<div class="container">
										<div class="row">
											<div class="col-md-12">
												<h2>
													<?php echo esc_html(get_theme_mod( 'home_heading_text', __('WRITE YOUR HEADING HERE','prasoon')));?>
												</h2>
												<p>
													<?php echo esc_html(get_theme_mod( 'home_subheading_text', __('change this to your subheading. You can change this in the customizer General Settings section','prasoon')));?>
												</p>
												<div class="learn-more">
													<?php 
			                      						if(""!=get_theme_mod( 'home_button_text' )){
													...
													<?php
			                      						...
			                      						if(""!=get_theme_mod( 'home_button2_text' )){
								...
								<?php
			     		         	if("yes" === get_theme_mod( 'home_scroll_down' )){
			                	?>
